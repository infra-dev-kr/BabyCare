 ...
 */
export declare class RobustPolynomialRegression extends BaseRegression {
    name?: string;
    degree?: number;
    powers?: number[];
    coefficients?: number[];
    constructor(x: number[] | LoadJSON, y?: number[], degree?: number);
    toJSON(): {
    ...
    static load(json: LoadJSON): RobustPolynomialRegression;
}
interface LoadJSON {
    name?: string;
    degree?: number;
